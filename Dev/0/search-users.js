...
const URL = `${config.user_search_api_url}`; //Your Users https://api.github.com/users/ImaniAN/followers
...
fetchAccounts(URL).then(result => {
  ...
  fs.writeFileSync('accounts-searched.json', JSON.stringify(result, null, 2));
});
